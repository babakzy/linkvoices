...
<div class="md:container md:mx-auto py-4 ">
    <div class="flex flex-wrap items-center mx-4">
        <div class=" basis-1/2 md:basis-1/4"> <nuxt-link  to="/"><img class=" max-w-full w-60" src="@/assets/images/linkvoices logo.svg" alt=""></nuxt-link> </div>
        <div class=" basis-1/2 md:basis-3/4 text-right text-blue-800"> <ul>
          <li v-if="user" class="md:mx-4 block md:inline-block">
            ...
            <li  v-if="user" class="mx-1 mt-4 md:mt-0 md:mx-4 inline-block">
      
              <button class=" cursor-pointer" @click="signOut()" >Sign Out</button>
            
            </li>
            <li v-else class="ml-1 mt-4  md:mt-0 md:mx-4 inline-block">
