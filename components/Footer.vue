<template>
    <div class="border-t py-8 bg-gray-50 mt-32">
        <div class="md:container md:mx-auto">
            <div class="flex flex-wrap mx-3">
                <div class="basis-full md:basis-1/4 mb-6">
                    <div class="flex flex-col">
                        <div class="text-2xl font-bold text-slate-700 mb-4">Linkvoices</div>
                        <p class="text-gray-600 mb-4">Decentralized invoicing powered by cryptocurrency</p>
                        <div>
                            <github-button 
                                class="mt-1" 
                                href="https://github.com/babakzy/linkvoices"
                                data-color-scheme="no-preference: light; light: light; dark: light;" 
                                data-icon="octicon-star"
                                data-size="large" 
                                aria-label="Star babakzy/linkvoices on GitHub">
                                Star
                            </github-button>
                        </div>
                    </div>
                ...
                <div class="basis-full md:basis-1/4 mb-6">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="mailto:babak@linkvoices.com" class="text-gray-600 hover:text-gray-900">Contact</a></li>
                    </ul>
                </div>
            ...
            <div class="border-t border-gray-200 mt-8 pt-8 mx-3">
                <div class="flex flex-wrap items-center justify-between">
                    ...
                    <div class="flex space-x-6">
                        ...
                        <a href="https://github.com/babakzy/linkvoices" class="text-gray-600 hover:text-gray-900">
